...
class Kind::ObjectInstanceTest < Minitest::Test
  def test_a_core_kind_object_receiving_a_kind
    string_checker = Kind::Object::Instance.new(::String, {})
    ...
    assert_equal('Kind::Object<String>', string_checker.inspect)
  ...
  def test_a_custom_kind_object_receiving_a_kind_name
    positive_integer_checker = Kind::Object::Instance.new(PositiveInteger, name: 'PositiveInteger')
    ...
    assert_equal('Kind::Object<PositiveInteger>', positive_integer_checker.inspect)
  ...
  def test_a_core_kind_object_receiving_an_object_that_doesnt_have_a_name
    assert_raises_with_message(
      Kind::Error,
